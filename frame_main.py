...
class mainframe ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"ĐIỂM DANH", pos = wx.DefaultPosition, size = wx.Size( 500,500 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.m_staticText2 = wx.StaticText( self, wx.ID_ANY, u"ĐIỂM DANH VÀ NHẬN DIỆN KHUÔN MẶT", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_button_run = wx.Button( self, wx.ID_ANY, u"ĐIỂM DANH", wx.DefaultPosition, wx.DefaultSize, 0 )
...
class MyDialog_type_name ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText = wx.StaticText( self, wx.ID_ANY, u"MaSV:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText.Wrap( -1 )
		bSizer.Add( self.m_staticText, 0, wx.ALL, 5 )
		...
		self.m_staticText = wx.StaticText( self, wx.ID_ANY, u"Class:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText.Wrap( -1 )
		bSizer.Add( self.m_staticText, 0, wx.ALL, 5 )
